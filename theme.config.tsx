...
const config: DocsThemeConfig = {
  ...
  navbar: {
    ...
    // extraContent: <div className={`navFormDiv`} style={{order: -1, display: `flex`, flexDirection: `row`, gridGap: 15, justifyContent: `space-between`, alignItems: `center`, marginRight: 8}}>
  ...
  //   component: <div className={`navFormDiv`} style={{order: -1, display: `flex`, flexDirection: `row`, gridGap: 15, justifyContent: `space-between`, alignItems: `center`, marginRight: 8}}>
  //   <span className={`navFormText textOverflow extended`} style={{minWidth: `fit-content`}}>Sign In</span>
  //   <section className={`navFormSection`} style={{maxWidth: 300, margin: 0, padding: `0 20px 0 0 !important`, position: `relative`}}>
  //     <Form id="navForm" style={{display: `flex`, flexDirection: `row`}} />
  //   </section>
  // </div>,
  // component: <NextraSearch>
  //   <div className={`navFormDiv`} style={{order: -1, display: `flex`, flexDirection: `row`, gridGap: 15, justifyContent: `space-between`, alignItems: `center`, marginRight: 8}}>
  //     <section className={`navFormSection`} style={{maxWidth: 300, margin: 0, padding: `0 20px 0 0 !important`, position: `relative`}}>
  //       <Form id="navForm" style={{display: `flex`, flexDirection: `row`}} />
  //     </section>
  //   </div>
